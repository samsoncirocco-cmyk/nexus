...
export default function CommandBar({ placeholder = 'Give Paul a command...', variant = 'full' }: CommandBarProps) {
    ...
    return (
      <form onSubmit={handleSubmit} className="flex items-center gap-2">
        ...
        <button
          ...
          className="shrink-0 size-11 rounded-xl bg-primary text-bg-dark flex items-center justify-center font-bold hover:bg-primary/90 active:scale-95 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-[0_0_16px_rgba(250,222,41,0.2)] hover:shadow-[0_0_24px_rgba(250,222,41,0.35)]"
        >
          {sending ? (
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-secondary-dark/60 to-card-dark p-5 shadow-lg scan-line">
      {/* Ambient glow */}
      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-3">
          ...
          <button
            type="submit"
            disabled={!text.trim() || sending}
            className="shrink-0 h-[46px] px-5 rounded-xl bg-primary text-bg-dark flex items-center gap-2 font-bold text-sm hover:bg-primary/90 active:scale-95 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(250,222,41,0.25)] hover:shadow-[0_0_30px_rgba(250,222,41,0.4)]"
          >
            {sending ? (
              <>
